...
\captionsetup*[figure]{name={},font={color=eLifeDarkBlue,small},skip=\smallskipamount,justification=justified}
\captionsetup*[table]{name={},font={color=eLifeDarkBlue,small},margin=0pt,indention=0cm}
\renewcommand{\thetable}{Table~\arabic{table}}
%\captionsetup{labelformat=empty}



\makeatletter\newcommand\newtag[2]{~\def\@currentlabel{#1}\label{#2}#1}\makeatother%
...
\begin{figure}[h]
\begin{fullwidth}
\includegraphics[width=1.0\linewidth]{software-overview.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=1\linewidth]{pipeline_overview.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{fig_normalization.pdf}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{memory_consumption.pdf}
...
\captionsetup*[table]{name={},font={color=eLifeDarkBlue,small}}
\captionsetup*[figure]{name={},font={color=eLifeDarkBlue,small},skip=\smallskipamount}
...
\begin{figure}
\includegraphics[width=1.0\linewidth]{segment_lengths.pdf}
...
\begin{figure}
\begin{fullwidth}
\includegraphics[width=1.0\linewidth]{mice_video_pics.pdf}
\captionsetup{margin=0pt,calcmargin={0pt,-4.5cm}}
...
\begin{figure}
\begin{fullwidth}
\includegraphics[width=1.0\linewidth]{mice_image.pdf}
\captionsetup{margin=0pt,calcmargin={0pt,-4.5cm}}
